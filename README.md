...
As of Helix 22.10, there is support for multiple language servers for language. This enables for instance, the use of `ruff-lsp` alongside a language server like `pyright`:
